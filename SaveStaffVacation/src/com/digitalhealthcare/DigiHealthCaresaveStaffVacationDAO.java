...
public class DigiHealthCaresaveStaffVacationDAO extends JdbcDaoSupport {

	public CISResults saveStaffVacation(String vacationId, String staffId,
		...
		try{
			// Capture service Start time
			 ...
			 getJdbcTemplate().update(DigiHealthCaresaveStaffVacationQuery.SQL_SAVESTAFFVACAION,vacationId,staffId,startTime,endTime,vacationNote,createDate);
			 ...
			 logger.info("save staff vacation  query time:: " +result);
