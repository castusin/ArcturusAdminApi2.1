...
public class DigiHealthCareDeleteStaffVacationDAO extends JdbcDaoSupport {
	...
	public CISResults deleteStaffVacation(String vacationId) {
		...
		Object[] inputs = new Object[]{vacationId};
		try{
			// Capture service Start time
			 TimeCheck time=new TimeCheck();
			 testServiceTime sessionTimeCheck=new testServiceTime();
			 String serviceStartTime=time.getTimeZone();
			 getJdbcTemplate().update(DigiHealthCareDeleteStaffVacationQuery.SQL_DELETESTAFFVACATION,inputs);
